 ...
 */
final class Version20260222084127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD link VARCHAR(255) DEFAULT NULL, DROP recommendation_id, DROP title, DROP type, CHANGE user_id user_id INT NOT NULL, CHANGE content content VARCHAR(255) NOT NULL, CHANGE is_read is_read TINYINT(1) NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification DROP FOREIGN KEY FK_BF5476CAA76ED395');
        $this->addSql('ALTER TABLE notification ADD recommendation_id INT DEFAULT NULL, ADD title VARCHAR(255) NOT NULL, ADD type VARCHAR(50) NOT NULL, DROP link, CHANGE content content LONGTEXT NOT NULL, CHANGE is_read is_read TINYINT(1) DEFAULT 0 NOT NULL, CHANGE created_at created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE user_id user_id INT DEFAULT NULL');
